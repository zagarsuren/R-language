...
```{r}
train <- read.csv("/1. MY DOCUMENTS/2. Data Mining/2.7. Kaggle/1. Kaggle_Datasets/House price prediciton/train.csv", stringsAsFactors = F)
test <- read.csv("/1. MY DOCUMENTS/2. Data Mining/2.7. Kaggle/1. Kaggle_Datasets/House price prediciton/test.csv", stringsAsFactors = F)
```
